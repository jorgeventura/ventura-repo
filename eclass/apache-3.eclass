...
# @ECLASS: apache-3.eclass
# @MAINTAINER:
# apache-bugs@gentoo.org
# @AUTHOR:
# polynomial-c@gentoo.org
# @SUPPORTED_EAPIS: 8
# @BLURB: Provides a common set of functions for apache-3.x ebuilds
# @DESCRIPTION:
# This eclass handles apache-3.x ebuild functions such as LoadModule generation
...
# @FUNCTION: apache-3_src_configure
# @DESCRIPTION:
...
# @FUNCTION: apache-3_pkg_postinst
# @DESCRIPTION:
