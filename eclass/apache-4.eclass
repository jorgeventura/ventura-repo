...
# @ECLASS: apache-4.eclass
# @MAINTAINER:
# apache-bugs@gentoo.org
# @AUTHOR:
# polynomial-c@gentoo.org
# @SUPPORTED_EAPIS: 7 8
# @BLURB: Provides a common set of functions for apache-4.x ebuilds
# @DESCRIPTION:
# This eclass handles apache-4.x ebuild functions such as LoadModule generation
...
# @FUNCTION: apache-4_src_configure
# @DESCRIPTION:
...
# @FUNCTION: apache-4_pkg_postinst
# @DESCRIPTION:
